...
import Logo from '../../images/HopageLgo.png'
const Home = () => {
    ...
    return (
        ...
        <div class="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-blue-500">
          <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
           ...
           <a href='https://rightupnextinnovations.com/' target='_blank'>

            <button type='button'
              class="bg-transparent border-2 border-white mt-12 transition-all text-gray-800 font-bold text-sm rounded-md px-6 py-2.5">Get Started</button>
              </a>
          </div>
  
          <div class="lg:h-[480px] flex items-center">
          <img src={Logo} className="w-full h-full object-contain animate-bounce-slow" alt="Dining Experience" />
