                ...
                <Grid container justifyContent="space-between" style={{marginTop: '40px'}} >
                    <Grid item style={{width: '50%'}}>
                        <Container>
                            ...
                            {client  && (
                                <>
                                    <Typography style={{marginTop:"10px"}}  variant="subtitle2" gutterBottom>{client.name}</Typography>
                                    <Typography style={{marginTop:"8px"}}  variant="body2" >{client.email}</Typography>
                                    <Typography style={{marginTop:"8px"}}  variant="body2" >{client.phone}</Typography>
                                    <Typography style={{marginTop:"8px"}}  variant="body2">{client.address}</Typography>
                                    <Button  color="primary" size="small" style={{textTransform: 'none',marginTop:"8px"}} onClick={()=> setClient(null)}>Change Customer</Button>
                                </>
                            )}
