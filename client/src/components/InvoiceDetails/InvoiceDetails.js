        ...
        <Container>
            <Grid container justifyContent="space-between" style={{marginTop: '40px'}} >
                ...
                <Grid item style={{marginRight: 20, textAlign: 'right'}}>
                    ...
                    <Typography variant="h6" gutterBottom>{currency} {toCommas(Math.round(total*10)/10)}</Typography>
                </Grid>
            </Grid>
        </Container>
            ...
            <TableRow key={index}>
              ...
              <TableCell align="right"> <InputBase sx={{ ml: 1, flex: 1 }} type="number" name="amount"  value={(itemField?.quantity * itemField.unitPrice) - (itemField.quantity * itemField.unitPrice) * itemField.discount / 100} readOnly /> </TableCell>
                ...
                <div className={styles.invoiceSummary}>
                    ...
                    <div className={styles.summaryItem}>
                        <p>Total</p>
                        <h4>{currency} {toCommas(Math.round(total*10)/10)}</h4>
                    </div>
                    <div className={styles.summaryItem}>
                        <p>Paid</p>
                        <h4>{currency} {toCommas(Math.round(totalAmountReceived*10)/10)}</h4>
                    </div>

                    <div className={styles.summaryItem}>
                        <p>Balance</p>
                        <h4 style={{ color: "black", fontSize: "18px", lineHeight: "8px" }}>
  {currency} {toCommas(Math.round((total - totalAmountReceived) * 100) / 100)}
</h4>
